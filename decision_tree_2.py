...
# SPECIFICATION: using decision tree with pre-pruning
...
for ds in dataSets:
    ...
    for i in range (10):
       ...
       for data in dbTest:
           ...
           #--> add your Python code here
           dbTestTransformed=[age[data[0]], spectacle[data[1]], astigmatism[data[2]], tear[data[3]]]
           class_predicted = clf.predict([dbTestTransformed[0:4]])[0]
